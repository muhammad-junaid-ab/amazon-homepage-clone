...
const Navbar = () => {
    return (
        <div className='h-[13vh] bg-black flex items-center justify-center'>
            ...
            <img className='h-18 pr-4 cursor-pointer' src={AmazonLogo } />
            <img className='bg-white h-9 py-1' src={GPS} />
            <div className='text-white mx-1.5 cursor-pointer'>
                <span className=''>Deliver to</span><br />
                <span className='font-bold'>PAK</span>
            </div>
            <img className='bg-yellow-500 h-11 ml-3' src={Search}/>
            ...
            <img className='h-10 bg-white ml-3 pt-1 pr-1 pl-0.5' src={ShoppingCart} alt="" />
